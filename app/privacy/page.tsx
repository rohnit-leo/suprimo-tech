  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "Send relevant marketing insights and industry updates",
    ...
    },
    {
      ...
      content: [
        ...
        "Anonymous data may be used for industry insights",
      ],
    },
  ]
              ...
              <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-purple-50">
                <CardContent className="p-8">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    This Privacy Policy explains how Suprimo Tech collects, uses, and protects your information when you
